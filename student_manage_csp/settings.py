"""
Django settings for student_manage_csp project.
...
SECRET_KEY = 'z(92!+p5j2+c#z)a@j*2ka-pclew&t53ikz+hc(5qi)s^=t)(q'
...
ROOT_URLCONF = 'student_manage_csp.urls'
...
WSGI_APPLICATION = 'student_manage_csp.wsgi.application'
